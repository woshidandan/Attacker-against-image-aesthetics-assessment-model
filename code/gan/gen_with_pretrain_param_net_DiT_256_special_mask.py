...
from .pretrain_param_model_DiT_256 import *
...
class UnetGenerator(nn.Module):
    def __init__(self, drop=0.1, batch=0):
        ...
        self.mask_brightness_fc = Mask_ConvNet(degree=0.9)
        self.mask_contrast_fc = Mask_ConvNet(degree=0.9)
        self.mask_saturation_fc = Mask_ConvNet(degree=0.9)
        self.mask_gamma_fc = Mask_ConvNet(degree=0.9)
        self.mask_hue_fc = Mask_ConvNet(degree=0.9)
        self.mask_sharpness_fc = Mask_ConvNet(degree=0.9)
        self.mask_box_blur_fc = Mask_ConvNet(degree=0.9)
        self.mask_equalize_fc = Mask_ConvNet(degree=0.8)
        self.mask_sobel_fc = Mask_ConvNet(degree=0.01)
    ...
    def forward(self, x, epoch, small_epoch, times):
        ...
        d1 = img.to(device)
        result = torch.zeros(self.filter_num, length, 3, 256, 256).to(device)
